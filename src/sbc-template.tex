...
% \begin{figure}[!tbp]
%   \centering
%   \subfloat[Flower one.]{\includegraphics[width=.5\textwidth]{images/image_01.png}\label{fig:filter01}}
%   \hfill
%   \subfloat[Flower one.]{\includegraphics[width=.5\textwidth]{images/image_02.png}\label{fig:filter02}}
%   \caption{Filtragem do cursor de VR. Amostras ruidosas em vermelho e valor filtrado em azul.}
% \end{figure}
