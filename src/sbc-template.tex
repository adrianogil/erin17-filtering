...
% Acrescentar a ilustração sobre o funcionamento básico de filtros aqui. Aqueles três quadrados
...
A primeira equação representa que cada $x_k$ é a combinação linear do valor anterior somado ao controle de sinal $_k$ e um ruído de processo. A seugnda equação mostra que qualquer valor medido é a combinação linear do valor do sinal $x_k$ a uma medida de ruído do medição. Os ruídos são gaussianos. 
